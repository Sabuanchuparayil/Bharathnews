...
const OnboardingModal = () => {
  ...
  useEffect(() => {
    ...
    setVisible(Boolean(user && !completed && !dismissed));
  }, [user, userProfile]);
      ...
      {visible && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg bg-white dark:bg-dark-surface-1 rounded-t-3xl sm:rounded-3xl shadow-floating border border-gray-200 dark:border-gray-800 overflow-hidden safe-bottom"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="p-6 border-b border-gray-100 dark:border-gray-800 relative">
              <button
                ...
                className="absolute top-4 right-4 touch-target hover:bg-surface-2 dark:hover:bg-dark-surface-2 rounded-xl transition-colors"
              >
              ...
              {ONBOARDING_CATEGORIES.map(cat => {
                ...
                return (
                  <button
                    ...
                    className={`relative p-4 rounded-2xl border-2 text-left transition-all duration-200 min-h-[44px] ${
                      isSelected
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      {Icon && <Icon className="w-4 h-4 text-brand-600 dark:text-brand-400 flex-shrink-0" />}
