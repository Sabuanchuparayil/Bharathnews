...
const CategoryPage = ({ category, title }) => {
  ...
  return (
    <Layout>
      <Helmet>
        <title>{title} | The Bharath News</title>
        <meta name="description" content={`Latest ${title.toLowerCase()} from The Bharath News. Coverage of India, GCC, business, and technology.`} />
        <link rel="canonical" href={`https://thebharathnews.com/${category}`} />
        <meta property="og:title" content={`${title} | The Bharath News`} />
        <meta property="og:description" content={`Latest ${title.toLowerCase()} from The Bharath News.`} />
