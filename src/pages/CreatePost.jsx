...
const CreatePost = () => {
  ...
  return (
    <Layout mainClassName="max-w-3xl mx-auto px-4 py-12">
      <Helmet><title>Create Content | The Bharath News</title></Helmet>
      ...
      <form onSubmit={e => handleSubmit(e, false)} className="glass-card-solid rounded-2xl p-6 sm:p-8 space-y-6">
        ...
        <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <Link to="/creator/space" className="px-6 py-2.5 text-sm text-gray-500 hover:text-brand-600">My Creator Space</Link>
        </div>
      </form>
    </Layout>
  );
