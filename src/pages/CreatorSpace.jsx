...
const CreatorSpace = () => {
  ...
  if (!isCreator) {
    return (
      <Layout mainClassName="max-w-xl mx-auto px-4 py-12 text-center">
        ...
        <Link to="/creator/apply" className="btn-primary px-6 py-2.5 rounded-xl">Apply Now</Link>
      </Layout>
    );
  }
  ...
  return (
    <Layout mainClassName="max-w-5xl mx-auto px-4 py-12">
      <Helmet><title>Creator Space | The Bharath News</title></Helmet>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          {profile && (
            <p className="text-gray-500 mt-1">
              <Link to={`/@${profile.slug}`} className="text-brand-600 hover:underline">@{profile.slug}</Link>
            </p>
          )}
        </div>
        <div className="flex items-center gap-2">
          ...
          <Link to="/creator/new" className="btn-primary flex items-center gap-2 px-5 py-2.5 rounded-xl">
