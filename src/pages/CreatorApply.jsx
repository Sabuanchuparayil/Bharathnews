...
const CreatorApply = () => {
  ...
  if (isCreator) {
    return (
      <Layout mainClassName="max-w-2xl mx-auto px-4 py-12">
        <Helmet><title>Creator Program | The Bharath News</title></Helmet>
        <div className="glass-card-solid rounded-2xl p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <Link to="/creator/new" className="btn-primary px-6 py-2.5 rounded-xl">Create Content</Link>
            <Link to="/creator/space" className="btn-secondary px-6 py-2.5 rounded-xl">Creator Space</Link>
          </div>
        </div>
      </Layout>
    );
  ...
  return (
    <Layout mainClassName="max-w-2xl mx-auto px-4 py-12">
      <Helmet>
        <title>Become a Creator | The Bharath News</title>
        <meta name="description" content="Apply to become a citizen journalist or community vlogger on Bharath News." />
      </Helmet>
