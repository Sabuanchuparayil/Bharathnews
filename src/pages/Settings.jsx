      ...
      <div className="glass-card-solid rounded-2xl divide-y divide-gray-100 dark:divide-gray-800">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap gap-2">
            {isCreator ? (
              <>
                <Link to="/creator/space" className="btn-primary text-sm flex items-center gap-1.5">
                  <PenLine className="w-3.5 h-3.5" /> Creator Space
                </Link>
                <Link to="/creator/new" className="btn-secondary text-sm">New Content</Link>
              </>
            ) : (
              <Link to="/creator/apply" className="btn-primary text-sm">Apply as Creator</Link>
            )}
          </div>
        </div>
