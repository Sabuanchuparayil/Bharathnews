  ...
  return (
    <Layout mainClassName="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
        <Link href="/creator/apply" className="glass-card-solid rounded-2xl p-6 card-lift block group">
        ...
        <Link href="/creator/new" className="glass-card-solid rounded-2xl p-6 card-lift block group">
        ...
        <Link href="/creator/space" className="glass-card-solid rounded-2xl p-6 card-lift block group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            ...
            <Link href="/creator/apply" className="text-brand-600 text-sm font-medium hover:underline">
