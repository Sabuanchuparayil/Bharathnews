    ...
    <Layout showBottomNav={false} showChatbot={false} mainClassName="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="glass-card-solid rounded-2xl p-6">
            ...
            <Link href="/admin/moderation" className="text-brand-600 hover:text-brand-700 text-sm font-medium">
          ...
          <div className="glass-card-solid rounded-2xl p-6">
            ...
            <Link href="/admin/dashboard" className="text-brand-600 hover:text-brand-700 text-sm font-medium">
